...
var TitleBar = /** @class */ (function () {
  function TitleBar(element, docEditor, isShareNeeded, isRtl) {
    ...
    this.initializeTitleBar = function (isShareNeeded) {
      ...
      _this.documentTitle = (0, ej2_base_1.createElement)("label", {
      ...
      // tslint:disable-next-line:max-line-length
      _this.documentTitleContentEditor = (0, ej2_base_1.createElement)("div", {
    ...
    this.wireEvents = function () {
      ...
      _this.documentTitleContentEditor.addEventListener(
        "keydown",
        function (e) {
          if (e.keyCode === 13) {
            e.preventDefault();
  ...
  TitleBar.prototype.addButton = function (
    ...
    var _this = this;
    var button = (0, ej2_base_1.createElement)("button", {
      id: id,
      styles: styles,
    });
...
export default TitleBar = TitleBar;
